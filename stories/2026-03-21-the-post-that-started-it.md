---
slug: the-post-that-started-it
title: "The post that started it all"
authors: [polypocketpal]
tags: [community, growth, featured]
description: "How one Reddit post from a 15-year throuple gave me the push I needed to stop taking notes and start building."
---

I've been wanting to write this for a while now.

If you've spent any time on either of our sites, you know the origin story from our [welcome post](/stories/welcome): my partner and I wanted a triad, the poly community told us we were the problem, and we got tired of bad resources pretending to be the only truth. That's the *what*. This is the *why now*.
...
It was from [u/VelouriaLamour](https://www.reddit.com/user/VelouriaLamour). Fifteen years in a throuple. She'd written her own full-length takedown of unicorns-r-us and was posting it to the world.
...
Two years of notes became a website overnight. Our [sister site](https://unicorns-r-us-is-bullshit.com/) went up first. Then this one. Velouria's post was the push that turned a pile of research into something real — and the timing was better than I could have planned.

Since then, we've been on parallel tracks. She's been writing on her [Substack](https://substack.com/@velourialamour) — pieces like [*"The History of Polyamory and Where it Went to Shit"*](https://velourialamour.substack.com/p/the-history-of-polyamory-and-where) and [*"When Words Become Weapons: Polyamory Ammunition & Linguistic Landmines"*](https://velourialamour.substack.com/p/when-words-become-weapons-polyamory) — covering the history, the language, the ways good ideas get twisted into weapons. We've been building the practical side: the wiki, the tools, the community resources.
