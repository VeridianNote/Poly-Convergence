---
title: About
description: What Poly Convergence is, why it exists, and how it works
---
...
- **[Featured](/featured)** -- Hand-picked stories and articles that explore specific topics in depth -- perspectives, analysis, and the kind of honest takes that don't fit neatly into a reference page.

## How it works

This is an open-source, community-built project. Anyone can [contribute](/contribute) through our web editor -- no technical skills required. Every submission gets reviewed before it goes live, so the site stays useful and trustworthy as it grows.
...
The non-commercial license exists for the same reason. This isn't content for someone else to package and sell. It belongs to the people who built it. If you have questions or concerns about licensing, [reach out to us on GitHub](https://github.com/VeridianNote/Poly-Convergence/issues).
...
We're not therapists, and this isn't professional advice. If you need help with something serious, find a therapist or counselor who understands non-monogamy -- they exist, and they're worth finding. Our [disclaimer](/disclaimer) page has tips on how to find one.
