---
sidebar_position: 1
title: "Relationship broken, add more people"
description: "Why opening up to fix an existing relationship problem almost always makes things worse, and what to do instead"
keywords: [opening relationship to fix problems, polyamory to save relationship, relationship broken add more people, unhealthy polyamory reasons, ethical non-monogamy motivations, opening up relationship mistakes]
---
...
- Did both partners arrive at this freely, or did one agree because the alternative felt worse? Consent given under pressure or exhaustion isn't the same as genuine agreement. [Poly under duress](/wiki/unhealthy-behaviors/poly-under-duress) covers that line in depth.
...
- [Poly under duress](/wiki/unhealthy-behaviors/poly-under-duress) — When one partner pressures the other into non-monogamy
- [Couples seeking a partner aren't always unicorn hunting](/wiki/stigma-myths-and-criticism/couples-arent-always-hunting) — Why the blanket accusation doesn't hold up
- [What harmful looks like (red flags)](/wiki/foundational-concepts/red-flags) — Patterns worth recognizing early
- [Evaluation toolkit](/wiki/foundational-concepts/evaluation-toolkit) — Tools for assessing whether a situation works for you
...
- [Getting started with non-monogamy](/wiki/foundational-concepts/getting-started) — For when you're ready to explore from a healthy place
