...
Most poly guidance focuses on what to avoid. [Red flags, warning signs, patterns to watch for](/wiki/foundational-concepts/red-flags) — that's useful, but it leaves a gap. What does it look like when it's going well?
...
Shared history, a shared home, social recognition — these are natural structural advantages, and they're not a problem by themselves. The green flag is when people recognize that reality and make sure it doesn't become leverage. The [power dynamics](/wiki/foundational-concepts/power-dynamics) page covers this in depth, but the short version matters here too.
