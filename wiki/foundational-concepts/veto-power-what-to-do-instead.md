...
Veto power can also reinforce an existing power imbalance. The couple has shared history, shared finances, shared living situations, and established social ties. Giving one of them the additional power to end any incoming relationship adds to those advantages. The new partner has no equivalent lever — though they bring their own (income, mobility, the ability to walk away without untangling a shared life). Power comes from [many sources](/wiki/foundational-concepts/power-dynamics#where-power-comes-from), and it doesn't always sit where the structure suggests. But in the specific context of "who can end this relationship," a formal veto is one-directional in a way that's hard to balance.
