...
Non-monogamy takes many forms. Some people have multiple romantic partners. Some have one committed relationship and casual connections with others. Some are in a closed group of three or more people who are exclusive to each other. There's no single "right" way to do this. Our [relationship structures page](/wiki/foundational-concepts/relationship-structures) covers these in detail, but the short version: these aren't rigid categories. Real relationships mix and evolve. The labels are tools for talking about what's happening, not boxes to live in.
...
It's **not** a sign that something is wrong with your current relationship. People don't open relationships because they're broken. They open them because they want something different or additional. If a relationship *is* broken, adding more people won't fix it — it'll make the existing problems louder. (More on that [here](/wiki/unhealthy-behaviors/relationship-broken-add-more-people).)
...
- Pressure from a partner. If one person wants this and the other is going along to avoid losing them, that's not consent. That's [poly under duress](/wiki/unhealthy-behaviors/poly-under-duress)
...
**Understanding power.** Every person brings advantages to a relationship — money, stability, experience, social connections, the ability to walk away without untangling a shared life. In non-monogamous dynamics, these advantages come from more directions and carry more weight. Recognizing them isn't guilt. It's awareness. The [power dynamics page](/wiki/foundational-concepts/power-dynamics) covers where power concentrates and what to do about it.

**Knowing what healthy looks like.** Most advice focuses on what to avoid. That's useful, but it leaves a gap. You need to know what you're building toward, not just what to steer around. Read about [green flags](/wiki/foundational-concepts/green-flags) and [red flags](/wiki/foundational-concepts/red-flags) so you can recognize both early.

**Getting the language right.** The poly community has its own vocabulary, and some of it carries baggage that isn't obvious until you trip over it. Words like "unicorn," "third," and "unicorn hunter" collapse very different things into a single label. The [terminology page](/wiki/foundational-concepts/terminology) breaks down what the words actually mean, which ones help, and which ones are used to shame people.
...
- [Relationship structures explained](/wiki/foundational-concepts/relationship-structures) — triads, Vs, solo poly, and everything in between. What they look like in practice, not just in theory
...
- [Key studies on non-monogamy](/wiki/research-and-sources/key-studies) — what the research actually says, and where it's honest-to-god silent

**If you're part of a couple exploring this:**
- [A practical guide for couples](/wiki/foundational-concepts/guide-for-couples) — specific tools, common mistakes, and what to think about before you start dating together
...
- [Evaluation toolkit](/wiki/foundational-concepts/evaluation-toolkit) — a structured framework for assessing whether a situation works for you. Goes both ways
...
- [Relationship structures explained](/wiki/foundational-concepts/relationship-structures) — What the common configurations look like and how they work
- [Terminology and language guide](/wiki/foundational-concepts/terminology) — The words used in these spaces and which ones carry baggage
- [A practical guide for couples](/wiki/foundational-concepts/guide-for-couples) — Specific guidance for couples exploring dating together
- [Key studies on non-monogamy](/wiki/research-and-sources/key-studies) — What the research actually says
- [Recommended reading](/wiki/research-and-sources/recommended-reading) — Books and resources worth your time
