...
- **"We've never done this before" paired with very firm rules.** If they're new to this but already have a rigid set of requirements, those rules are probably based on fear, not experience. A useful test from the [agreements page](/wiki/foundational-concepts/empowering-vs-controlling-agreements): would this rule exist in any new relationship, or does it only exist because there's a new person? "We practice safe sex" is a boundary everyone holds. "You can't see us separately" only makes sense as control.
...
- [What healthy looks like](/wiki/foundational-concepts/green-flags) -- Positive patterns across all relationship configurations
