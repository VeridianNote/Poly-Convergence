...
1. **Structure** — the shape of the relationship. A couple, a triad, a V, a polycule. This describes who is connected to whom.
2. **Intent** — what people are trying to do. Looking for a casual hookup, seeking a committed partner, exploring something new.
3. **Behavior** — how people actually treat each other. Respectful, controlling, honest, exploitative.
...
- [Relationship structures explained](/wiki/foundational-concepts/relationship-structures) — What the common configurations actually look like
- [Power dynamics and couple privilege](/wiki/foundational-concepts/power-dynamics) — How power shows up when someone enters an existing relationship
- [What harmful looks like](/wiki/foundational-concepts/red-flags) — Specific behaviors to watch for, named precisely
