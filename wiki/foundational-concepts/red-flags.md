...
Something feels off but you can't quite name it. Or maybe you can name it but you're not sure if it's actually a problem. What follows names specific behaviors that indicate something is wrong — not structures, behaviors. A triad can have these. A V can have these. A monogamous relationship can have every single one. The shape isn't the issue. How people treat each other is.

These are organized into red flags (get out or get help now) and yellow flags (concerning but potentially fixable with awareness and effort). For the other side of this — what it looks like when things are going well — see [green flags](/wiki/foundational-concepts/green-flags).
...
## 🚩 Red flags: patterns that cause real harm
...
One person has freedoms the others don't — dating independently, spending time with friends, making plans without checking in — while another partner faces restrictions that don't apply to anyone else. One person's boundaries are "reasonable limits" while someone else's boundaries are "being difficult."

**Why it matters:** Asymmetric rules aren't real agreements — they're one person's control framed as something mutual. If the rules consistently benefit one person or one side at another's expense, they're not mutual — they're imposed. This shows up in couples, Vs, polycules, monogamous relationships — any dynamic where power flows one direction. A hinge who applies different standards to each partner. A couple where one person dates freely while the other faces restrictions. A polycule where newer members have rules the established members don't follow. The configuration doesn't matter. The pattern does.

### The disposability pattern

Someone is treated as replaceable. Their individuality doesn't matter — what matters is that they fill a role. This shows up as:
...
This goes in every direction. A couple can treat a new partner as interchangeable, but a person dating couples can treat every couple as interchangeable too, cycling through them looking for a perfect fit without investing in any of them. The red flag is the same behavior — treating people as roles to fill rather than humans to connect with.

### Punishment for honest feelings
...
- "That never happened." "You're remembering it wrong." "I never said that." — rewriting history or making someone doubt their own experience until they stop trusting their own read on things.
...
Gradually separating someone from their own friends, family, or support system. The signal isn't how much time you spend together — healthy closeness encourages independence. Isolating closeness quietly replaces it.
...
What was described at the start doesn't match what's actually happening. Promises made during the early phase quietly disappear once everyone is invested. The common thread is misrepresentation — someone said one thing to get emotional investment, then became someone different once that investment existed. This happens in every configuration:

- Someone attentive and invested during early dating who stops putting in effort once commitment is secured — after moving in, getting married, once they feel the other person isn't going anywhere
...
The dynamic shifts when they feel locked in. The shape of the relationship doesn't matter — the pattern is someone who shows you one version of themselves to earn your investment, then reveals another once you're in deep enough that leaving feels harder than staying.

## ⚠️ Yellow flags: fixable but worth paying attention to
...
### Assumptions about someone's role
...
Decisions get made by some people in the relationship and presented to others as settled. Not all the time and not about everything — but about things that affect everyone. The person left out gets a result, not a conversation.

A hinge making decisions for a V without consulting both partners. A polycule where the longer-established members decide things and inform newer ones afterward. A couple who settles something between themselves and tells a new partner how it's going to be. The configuration varies — the pattern is the same.
...
Everything moves very fast. Deep emotional declarations early. Spending every available moment together. Immediate integration into each other's lives. New Relationship Energy (NRE) is powerful, and it doesn't care about structure — it hits just as hard in a V, a triad, or a new monogamous relationship.
